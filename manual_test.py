...
tullock_lover = Player("NASTY Tullock", [tullock])
graaskamp_lover = Player("NASTY Graaskamp", [graaskamp])
stein_and_rapoport_lover = Player("NICE Stein and Rapoport", [stein_and_rapoport])
tideman_and_chieruzzi_lover = Player("NICE Tideman and Chieruzzi", [tideman_and_chieruzzi])
shubik_lover = Player("NICE Shubik", [shubik])
feld_lover = Player("NASTY Feld", [feld])
anonymous_lover = Player("NASTY Anonymous", [anonymous])
nydegger_lover = Player("NICE Nydegger", [nydegger])
downing_lover = Player("NASTY Downing", [downing])
