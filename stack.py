"""
Code modifié de la librairie Axelrod
https://github.com/Axelrod-Python/Axelrod/blob/dev/axelrod/plot.py
...
class Betterplot(object):
    ...
    def stackplot(
        ...
        ax.stackplot(turns, *pops, colors=["dimgray", "lightgray", "lightcoral", "red", "tomato", "sienna", "orange", "darkgoldenrod", "gold", "darkkhaki", "olive", "yellow", "lawngreen", "darkgreen", "aquamarine", "lightseagreen", "darkslategray", "cyan", "dodgerblue", "navy", "indigo", "violet", "purple", "magenta", "deeppink"], alpha=0.8)
